...
public class MedcoSportsMedicineExcelRow extends ExcelRow{
    ...
    public MedcoSportsMedicineExcelRow(String customerDescription, String itemName, String manufacturer, String sku, int quantityRequested, double msrp, double wholeSalePrice, String productURL) {
       super(customerDescription,itemName, manufacturer, sku, quantityRequested, msrp, wholeSalePrice,productURL);
    }
